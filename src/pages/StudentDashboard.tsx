...
const StudentDashboard = () => {
  ...
  useEffect(() => {
    ...
    const sessionsQuery = query(collection(db, "sessions"), where("studentId", "==", user.uuid));
  ...
  const handleBookSession = async (sessionData: any) => {
    ...
    try {
        ...
        const newSession = {
            ...
            advisorName: `${primaryAdvisor.name} ${primaryAdvisor.surname}`,
            sessionDateTime,
            status: 'Pending',
            sessionType,
            ...
            <div className="flex items-center justify-between mb-8">
                {isSidebarOpen && (
                    ...
                    >
                        ...
                        <span className="text-lg font-semibold">{userProfile.name} {userProfile.surname}</span>
                    </div>
                )}
            ...
            <CardContent className="p-4 flex flex-col sm:flex-row justify-between sm:items-center gap-4">
                <div className="flex-1">
                    <div className="flex items-center gap-3 mb-1">
                        <p className="font-semibold">{session.advisorName}</p>
